...
*** Launch a local instance
    ...
    You need to have a redis installation running on your computer or
    you can start it (after installing it using your package manager) with:
    #+begin_src sh
    ...
    #+begin_src sh
      cd orchestrator
      pipenv run rq worker export &
      pipenv run rq worker delta &
    #+end_src
*** Code structure
**** Django apps
