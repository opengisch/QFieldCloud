...
class QfcTestCase(APITransactionTestCase):
    ...
    def test_max_premium_collaborators_per_private_project(self):
        ...
        self.assertProjectRole(
            p1, u1, ProjectCollaboratorRole.ADMIN, ProjectRoleOrigins.ORGANIZATIONOWNER
        )
        self.assertProjectRole(
            p1, u2, ProjectCollaboratorRole.ADMIN, ProjectRoleOrigins.ORGANIZATIONADMIN
        )
        ...
        p1.collaborators.create(collaborator=t_01, role=ProjectCollaboratorRole.READER)
        p1.collaborators.create(
            collaborator=t_02, role=ProjectCollaboratorRole.REPORTER
        )
        p1.collaborators.create(collaborator=t_03, role=ProjectCollaboratorRole.EDITOR)
        p1.collaborators.create(collaborator=t_04, role=ProjectCollaboratorRole.MANAGER)
        p1.collaborators.create(collaborator=t_05, role=ProjectCollaboratorRole.ADMIN)
        ...
        self.assertProjectRole(
            p1, u3, ProjectCollaboratorRole.READER, ProjectRoleOrigins.TEAMMEMBER
        )
        self.assertProjectRole(
            p1, u4, ProjectCollaboratorRole.REPORTER, ProjectRoleOrigins.TEAMMEMBER
        )
        self.assertProjectRole(
            p1, u5, ProjectCollaboratorRole.EDITOR, ProjectRoleOrigins.TEAMMEMBER
        )
        self.assertProjectRole(
            p1, u6, ProjectCollaboratorRole.MANAGER, ProjectRoleOrigins.TEAMMEMBER
        )
        self.assertProjectRole(
            p1, u7, ProjectCollaboratorRole.ADMIN, ProjectRoleOrigins.TEAMMEMBER
        )
        self.assertProjectRole(p1, u8, None, None)

        # add more collaborators
        p1.collaborators.create(collaborator=u3, role=ProjectCollaboratorRole.READER)
        p1.collaborators.create(collaborator=u4, role=ProjectCollaboratorRole.REPORTER)
        p1.collaborators.create(collaborator=u5, role=ProjectCollaboratorRole.EDITOR)
        p1.collaborators.create(collaborator=u6, role=ProjectCollaboratorRole.MANAGER)
        p1.collaborators.create(collaborator=u7, role=ProjectCollaboratorRole.ADMIN)
        ...
        self.assertProjectRole(
            p1, u3, ProjectCollaboratorRole.READER, ProjectRoleOrigins.COLLABORATOR
        )
        self.assertProjectRole(
            p1, u4, ProjectCollaboratorRole.REPORTER, ProjectRoleOrigins.COLLABORATOR
        )
        self.assertProjectRole(
            p1, u5, ProjectCollaboratorRole.EDITOR, ProjectRoleOrigins.COLLABORATOR
        )
        self.assertProjectRole(
            p1, u6, ProjectCollaboratorRole.MANAGER, ProjectRoleOrigins.COLLABORATOR
        )
        self.assertProjectRole(
            p1, u7, ProjectCollaboratorRole.ADMIN, ProjectRoleOrigins.COLLABORATOR
        )
        self.assertProjectRole(p1, u8, None, None)
        ...
        self.assertProjectRole(
            ...
            ProjectRoleOrigins.ORGANIZATIONOWNER,
            False,
        )
        self.assertProjectRole(
            p1,
            u2,
            ProjectCollaboratorRole.ADMIN,
            ProjectRoleOrigins.ORGANIZATIONADMIN,
            False,
        )
        self.assertProjectRole(
            p1,
            ...
            ProjectRoleOrigins.COLLABORATOR,
            False,
        )
        self.assertProjectRole(
            p1,
        ...
        self.assertProjectRole(
            p1, u7, ProjectCollaboratorRole.ADMIN, ProjectRoleOrigins.COLLABORATOR, True
        )
        self.assertProjectRole(p1, u8, None, None)
        ...
        self.assertProjectRole(
            p1, u8, ProjectCollaboratorRole.READER, ProjectRoleOrigins.PUBLIC, True
        )
