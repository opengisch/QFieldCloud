...
allowed_symbols_validator = RegexValidator(
    r"^[-a-zA-Z0-9_]+$", "Only letters, numbers, underscores or hyphens are allowed."
)

min_lenght_validator = RegexValidator(
    r"^.{3,}$", "The name must be at least 3 characters long."
)

first_symbol_validator = RegexValidator(
    r"^[a-zA-Z].*$", "The name must begin with a letter."
)
